  ...
  return (
    <Stack sx={styles.parentContainer}>
      ...
      <Typography variant="p" sx={{mt:2}}>
        Submit the email connected to your Local Eats account and we'll send it a 6 digit PIN. You'll be redirected to
        a new page where that PIN can be entered to change your login
        credentials
      </Typography>
