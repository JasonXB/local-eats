...
export default function SearchResults(props) {
  ...
  const fetchYelpData = async function (inp) {
    ...
    try {
      ...
      // Update redux values for numberOfHits and restaurantList (store/search/results)
      dispatch(
  ...
  return (
    <Box sx={{ px: 4 }}>
      ...
      {showGeneralError && <NoResults msg="Something's gone wrong on our end. Please try again" />}
