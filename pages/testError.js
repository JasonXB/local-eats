...
// MENU 1 DEFAULT: Arizona
// MENU 2 DEFAULT: Whatever cities yelp has data for in Arizona
// Changing the Menu 1 value will change the cities listed in menu 2
export default function testError() {
  ...
  // Take the state value in Menu 1 and save it to a state variable
  ...
  // The state selected will determine what cities are listed in Menu 2
  const citiesForSelectedState = yelpCoverageCities[selectedState];
